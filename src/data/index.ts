...
export const experiences: Experience[] = [
  {
    ...
    description: "Recognized as the firm's Azure Subject Matter Expert, architecting and leading cloud transformation across a global Azure environment serving 5,200 users, three major firm-wide applications, and 49 offices worldwide. Drives AI-powered automation strategy, infrastructure modernization, and org-wide cloud adoption.",
    responsibilities: [
      "Cloud Education & Adoption: Founded and scaled GT Learn To Cloud program, engaging ~130 technical staff in cloud training and certification pathways — resulting in 7+ employees earning cloud certifications and measurably accelerating firm-wide cloud adoption",
